(function(){
	...
	usage= function(){
		console.log("\nUsage: slimerjs echarts-convert.js -options options -outfile filename -width width -height height" + "OR" + "Usage: slimerjs echarts-convert.js -infile URL -outfile filename -width width -height height\n");
	};
